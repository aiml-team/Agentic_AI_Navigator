...
async def list_scenario_suggestions(
    ...
    offset = (page - 1) * per_page
    rows = conn.execute(
        f"SELECT * FROM scenario_suggestions {where_sql} ORDER BY submitted_at DESC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY",
...
async def saml_metadata():
    ...
    base_url = "https://ai-navigator-test-cbeedsgsd8hyfefq.northeurope-01.azurewebsites.net"

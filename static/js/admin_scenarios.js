...
(function () {
  ...
  function initSuggestModal() {
    ...
    /* show/hide Activate Phase exactly like Register Scenario does */
    ...
    function _reset() {
      ...
      submitBtn.innerHTML = '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg> Submit Scenario';
    }

...
(function () {
  ...
  /* ── Per-mega-group dot colors (matches mockup palette) ── */
  const MEGA_DOT_COLORS = {
    'Win Work':             '#3498db',
    'Deliver Projects':     '#27ae60',
    'Run Services':         '#e67e22',
    'Build Solutions':      '#8e44ad',
    'Lead & Communicate':   '#16a085',
    'Manage the Business':  '#e74c3c',
    'Govern AI':            '#c0392b',
    'Compete & Learn':      '#2980b9',
    'Cross-Functional':     '#7f8c8d',
  };

  /* ── Per-mega-group section bg/border colors for card headings ── */
  const MEGA_SECTION_COLORS = {
    'Win Work':             { bg: 'rgba(52,152,219,0.07)',  border: '#3498db', text: '#1a5276' },
    'Deliver Projects':     { bg: 'rgba(39,174,96,0.07)',   border: '#27ae60', text: '#145a32' },
    'Run Services':         { bg: 'rgba(230,126,34,0.07)',  border: '#e67e22', text: '#784212' },
    'Build Solutions':      { bg: 'rgba(142,68,173,0.07)',  border: '#8e44ad', text: '#4a235a' },
    'Lead & Communicate':   { bg: 'rgba(22,160,133,0.07)', border: '#16a085', text: '#0e6655' },
    'Manage the Business':  { bg: 'rgba(231,76,60,0.07)',   border: '#e74c3c', text: '#922b21' },
    'Govern AI':            { bg: 'rgba(192,57,43,0.07)',   border: '#c0392b', text: '#78281f' },
    'Compete & Learn':      { bg: 'rgba(41,128,185,0.07)',  border: '#2980b9', text: '#1a5276' },
    'Cross-Functional':     { bg: 'rgba(127,140,141,0.07)', border: '#7f8c8d', text: '#2c3e50' },
  };
  ...
  function initRegisterScenarioModal() {
    ...
    function closeModal() {
      ...
      if (saveBtn) {
        ...
        saveBtn.innerHTML = '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg> Save Scenario';
      }
      _resetBulk();
    }
